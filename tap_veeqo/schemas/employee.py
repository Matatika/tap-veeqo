...
_PermissionsObject = th.PropertiesList(
    ...
    th.Property("manage_users", th.BooleanType),
    ...
    th.Property("view_profit_analyzer", th.BooleanType),
    ...
    th.Property("manage_billing_settings", th.BooleanType),
...
EmployeeObject = th.PropertiesList(
    ...
    th.Property("created_at", th.DateTimeType),
    th.Property("updated_at", th.DateTimeType),
    th.Property("email_confirmation_state", th.StringType),  # not_required
    th.Property("email_confirmed_at", th.DateTimeType),
    th.Property("email_confirmation_requested_at", th.DateTimeType),
