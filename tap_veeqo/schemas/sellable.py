"""Schema definitions for sellable objects."""
...
_ProductObject = th.PropertiesList(
...
_StockEntryObject = th.PropertiesList(
...
_VariantPropertySpecificObject = th.PropertiesList(
    th.Property("id", th.IntegerType),
...
_MeasurementAttributesObject = th.PropertiesList(
    th.Property("id", th.IntegerType),
...
SellableObject = th.PropertiesList(
